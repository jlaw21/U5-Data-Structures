...
public class Main {
    ...
    Firstly, you do not need to know the size of the ArrayList when declaring it and you can add and remove elements and the size will update.
    ...
    public static void main(String[] args) {
        ...
        /*System.out.println("Removed Element 2 From Array");
        diceArray[2] = new Die();
        for(Die die: diceArray){
            System.out.println("Array Dice:" + die.getValue());
        }*/
